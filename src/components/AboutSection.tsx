        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            {highlights.map((highlight, index) => (
              <div
                key={index}
                className="group bg-gray-800/20 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 hover:border-cyan-400/50 hover:bg-gray-800/40 transition-all duration-300 hover:scale-105"
              >
